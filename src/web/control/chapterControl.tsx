      ...
      content.addBlock({
        initElement: (
          <div className='recommended-chapters'>
            ...
            <p>你也可以<a className='regular' href={ chapterHref('META/阅读器技术文档/推荐算法.html') }>点此查看《可穿戴科技》当前使用的推荐算法</a>。</p>
          </div>
        ) as HTMLDivElement,
...
function loadChapter(
  ...
  document.title = formatRelativePath(chapterHtmlRelativePath) + ' - 可穿戴科技';
